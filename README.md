...
[![Discussions](https://img.shields.io/badge/Discussions-Welcome-6f42c1?logo=github)](https://github.com/KontractKoder/meshdns/discussions)
...
```bash
go install github.com/KontractKoder/meshdns/cmd/meshdns@latest
```

Or grab the pre-built binary from [releases](https://github.com/KontractKoder/meshdns/releases)
...
- 💬 [**Discussions**](https://github.com/KontractKoder/meshdns/discussions) — ideas, Q&A, show and tell
- 🐛 [**Issues**](https://github.com/KontractKoder/meshdns/issues) — bug reports
